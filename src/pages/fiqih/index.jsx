...
import { ArrowLeft, Search, Scale, BookOpen, Sparkles } from 'lucide-react';
        ...
        {filteredData.length > 0 ? (
          ...
          <div className='text-center py-20 px-4'>
            ...
            <p className='text-sm text-slate-500 mb-6'>
              Pertanyaan fiqihmu belum ada di daftar. Yuk, tanyakan langsung ke
              Konsultan AI Ramatalk!
            </p>
            <button
              onClick={() =>
                router.push(
                  `/ramatalk?mode=fiqih&q=${encodeURIComponent(searchQuery)}`,
                )
              }
